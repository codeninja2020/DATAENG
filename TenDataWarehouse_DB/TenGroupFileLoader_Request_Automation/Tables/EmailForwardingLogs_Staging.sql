CREATE TABLE [TenGroupFileLoader_Request_Automation].[EmailForwardingLogs_Staging] (
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCIX_TenGroupFileLoader_Request_Automation_EmailForwardingLogs_Staging]
    ON [TenGroupFileLoader_Request_Automation].[EmailForwardingLogs_Staging];
