CREATE TABLE [Genesys_dbo].[AgentServiceLevelOverflows] (
    ...
    CONSTRAINT [PK_Genesys_dbo_AgentServiceLevelOverflows] PRIMARY KEY CLUSTERED ([OverflowGroupSet] ASC, [StatisticsSet] ASC)
);
