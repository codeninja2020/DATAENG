CREATE TABLE [Genesys_dbo].[AgentStatistics] (
    ...
    [tAgentAvailable]               INT NULL,
    [tAgentDnd]                     INT NULL,
    [tAgentInAcw]                   INT NULL,
    [tAgentLoggedIn]                INT NULL,
    [tAgentLoggedInDiluted]         INT NOT NULL,
    [tAgentNotAvailable]            INT NULL,
    [tAgentOnAcdCall]               INT NULL,
    [tAgentOnNonAcdCall]            INT NULL,
    [tAgentOnOtherAcdCall]          INT NULL,
    [tAgentOtherBusy]               INT NULL,
    [tAgentTalk]                    INT NULL,
    ...
    CONSTRAINT [PK_Genesys_dbo_AgentStatistics] PRIMARY KEY CLUSTERED ([StatisticsSet] ASC)
);
