CREATE TABLE [Genesys_dbo].[DQServiceLevelOverflows] (
    ...
    CONSTRAINT [PK_Genesys_dbo_DQServiceLevelOverflows] PRIMARY KEY CLUSTERED ([OverflowGroupSet] ASC, [StatisticsSet] ASC)
);
