CREATE TABLE [RedShift_visa].[member_remove_preference_event] (
    ...
    CONSTRAINT [PK_RedShift_visa_member_remove_preference_eventId] PRIMARY KEY CLUSTERED ([member_remove_preference_eventId] ASC)
);
