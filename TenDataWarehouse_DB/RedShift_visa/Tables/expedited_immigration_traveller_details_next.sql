CREATE TABLE [RedShift_visa].[expedited_immigration_traveller_details_next] (
    ...
    CONSTRAINT [PK_RedShift_visa_expedited_immigration_traveller_details_nextId] PRIMARY KEY CLUSTERED ([expedited_immigration_traveller_details_nextId] ASC)
);
