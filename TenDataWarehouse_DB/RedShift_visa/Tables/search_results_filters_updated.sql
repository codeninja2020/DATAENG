CREATE TABLE [RedShift_visa].[search_results_filters_updated] (
    ...
    CONSTRAINT [PK_RedShift_visa_search_results_filters_updatedId] PRIMARY KEY CLUSTERED ([search_results_filters_updatedId] ASC)
);
