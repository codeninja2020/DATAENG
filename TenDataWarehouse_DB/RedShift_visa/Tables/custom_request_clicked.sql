CREATE TABLE [RedShift_visa].[custom_request_clicked] (
    ...
    CONSTRAINT [PK_RedShift_visa_custom_request_clickedId] PRIMARY KEY CLUSTERED ([custom_request_clickedId] ASC)
);
