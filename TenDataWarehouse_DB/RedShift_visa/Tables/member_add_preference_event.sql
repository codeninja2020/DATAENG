CREATE TABLE [RedShift_visa].[member_add_preference_event] (
    ...
    CONSTRAINT [PK_RedShift_visa_member_add_preference_eventId] PRIMARY KEY CLUSTERED ([member_add_preference_eventId] ASC)
);
