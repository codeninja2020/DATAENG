CREATE TABLE [RedShift_swisscard].[table_request_non_bookable] (
    [table_request_non_bookableID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_table_request_non_bookableID] PRIMARY KEY CLUSTERED ([table_request_non_bookableID] ASC)
);
