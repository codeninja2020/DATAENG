CREATE TABLE [RedShift_swisscard].[entertainment_location_filter_cleared] (
    [entertainment_location_filter_clearedID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_entertainment_location_filter_clearedID] PRIMARY KEY CLUSTERED ([entertainment_location_filter_clearedID] ASC)
);
