CREATE TABLE [RedShift_swisscard].[member_remove_preference_event] (
    ...
    CONSTRAINT [PK_member_remove_preference_eventID] PRIMARY KEY CLUSTERED ([member_remove_preference_eventID] ASC)
);
