CREATE TABLE [RedShift_swisscard].[available_time_slot_selected] (
    [available_time_slot_selectedID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_available_time_slot_selectedID] PRIMARY KEY CLUSTERED ([available_time_slot_selectedID] ASC)
);
