CREATE TABLE [RedShift_swisscard].[custom_request_submitted] (
    ...
    CONSTRAINT [PK_RedShift_swisscard_custom_request_submittedId] PRIMARY KEY CLUSTERED ([custom_request_submittedId] ASC)
);
