CREATE TABLE [RedShift_swisscard].[member_add_preference_event] (
    ...
    CONSTRAINT [PK_member_add_preference_eventID] PRIMARY KEY CLUSTERED ([member_add_preference_eventID] ASC)
);
