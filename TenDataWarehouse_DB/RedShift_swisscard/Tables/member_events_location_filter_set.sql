CREATE TABLE [RedShift_swisscard].[member_events_location_filter_set] (
    [member_events_location_filter_setID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_member_events_location_filter_setID] PRIMARY KEY CLUSTERED ([member_events_location_filter_setID] ASC)
);
