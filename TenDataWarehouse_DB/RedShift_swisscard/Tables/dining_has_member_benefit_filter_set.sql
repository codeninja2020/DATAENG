CREATE TABLE [RedShift_swisscard].[dining_has_member_benefit_filter_set] (
    [dining_has_member_benefit_filter_setID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_dining_has_member_benefit_filter_setID] PRIMARY KEY CLUSTERED ([dining_has_member_benefit_filter_setID] ASC)
);
