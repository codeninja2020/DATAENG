CREATE TABLE [RedShift_swisscard].[member_events_location_filter_cleared] (
    [member_events_location_filter_clearedID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_member_events_location_filter_clearedID] PRIMARY KEY CLUSTERED ([member_events_location_filter_clearedID] ASC)
);
