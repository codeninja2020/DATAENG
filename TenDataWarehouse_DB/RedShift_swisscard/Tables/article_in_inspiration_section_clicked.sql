CREATE TABLE [RedShift_swisscard].[article_in_inspiration_section_clicked] (
    [article_in_inspiration_section_clickedID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_article_in_inspiration_section_clickedID] PRIMARY KEY CLUSTERED ([article_in_inspiration_section_clickedID] ASC)
);
