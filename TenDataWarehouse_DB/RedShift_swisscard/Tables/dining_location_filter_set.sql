CREATE TABLE [RedShift_swisscard].[dining_location_filter_set] (
    [dining_location_filter_setID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_dining_location_filter_setID] PRIMARY KEY CLUSTERED ([dining_location_filter_setID] ASC)
);
