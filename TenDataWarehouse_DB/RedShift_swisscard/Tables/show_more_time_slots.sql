CREATE TABLE [RedShift_swisscard].[show_more_time_slots] (
    [show_more_time_slotsID]  BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_show_more_time_slotsID] PRIMARY KEY CLUSTERED ([show_more_time_slotsID] ASC)
);
