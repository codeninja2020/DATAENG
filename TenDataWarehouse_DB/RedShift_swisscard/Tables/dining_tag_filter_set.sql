CREATE TABLE [RedShift_swisscard].[dining_tag_filter_set] (
    [dining_tag_filter_setID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_dining_tag_filter_setID] PRIMARY KEY CLUSTERED ([dining_tag_filter_setID] ASC)
);
