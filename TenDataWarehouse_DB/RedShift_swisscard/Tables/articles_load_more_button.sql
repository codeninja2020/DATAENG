CREATE TABLE [RedShift_swisscard].[articles_load_more_button] (
    ...
    CONSTRAINT [PK_articles_load_more_buttonID] PRIMARY KEY CLUSTERED ([articles_load_more_buttonID] ASC)
);
