CREATE TABLE [RedShift_swisscard].[submit_dining_booking] (
    [submit_dining_bookingID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_submit_dining_bookingID] PRIMARY KEY CLUSTERED ([submit_dining_bookingID] ASC)
);
