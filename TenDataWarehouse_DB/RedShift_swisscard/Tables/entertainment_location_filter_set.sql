CREATE TABLE [RedShift_swisscard].[entertainment_location_filter_set] (
    [entertainment_location_filter_setID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_entertainment_location_filter_setID] PRIMARY KEY CLUSTERED ([entertainment_location_filter_setID] ASC)
);
