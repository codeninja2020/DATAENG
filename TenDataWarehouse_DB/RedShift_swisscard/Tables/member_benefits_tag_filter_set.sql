CREATE TABLE [RedShift_swisscard].[member_benefits_tag_filter_set] (
    [member_benefits_tag_filter_setID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_member_benefits_tag_filter_setID] PRIMARY KEY CLUSTERED ([member_benefits_tag_filter_setID] ASC)
);
