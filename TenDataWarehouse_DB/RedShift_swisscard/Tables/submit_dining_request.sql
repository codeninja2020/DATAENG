CREATE TABLE [RedShift_swisscard].[submit_dining_request] (
    [submit_dining_requestID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_submit_dining_requestID] PRIMARY KEY CLUSTERED ([submit_dining_requestID] ASC)
);
