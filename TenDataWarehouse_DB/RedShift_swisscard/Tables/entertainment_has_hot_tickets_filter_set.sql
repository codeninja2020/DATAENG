CREATE TABLE [RedShift_swisscard].[entertainment_has_hot_tickets_filter_set] (
    [entertainment_has_hot_tickets_filter_setID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_entertainment_has_hot_tickets_filter_setID] PRIMARY KEY CLUSTERED ([entertainment_has_hot_tickets_filter_setID] ASC)
);
