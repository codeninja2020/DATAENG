CREATE TABLE [RedShift_swisscard].[dining_location_filter_cleared] (
    [dining_location_filter_clearedID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_dining_location_filter_clearedID] PRIMARY KEY CLUSTERED ([dining_location_filter_clearedID] ASC)
);
