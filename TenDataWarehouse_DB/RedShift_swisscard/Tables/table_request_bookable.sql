CREATE TABLE [RedShift_swisscard].[table_request_bookable] (
    [table_request_bookableID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_table_request_bookableID] PRIMARY KEY CLUSTERED ([table_request_bookableID] ASC)
);
