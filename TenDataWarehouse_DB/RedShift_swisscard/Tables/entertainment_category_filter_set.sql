CREATE TABLE [RedShift_swisscard].[entertainment_category_filter_set] (
    [entertainment_category_filter_setID] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_entertainment_category_filter_setID] PRIMARY KEY CLUSTERED ([entertainment_category_filter_setID] ASC)
);
