CREATE TABLE [RedShift_coutts_production].[member_remove_preference_event] (
    ...
    [member_remove_preference_eventId] BIGINT         IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_RedShift_coutts_production_member_remove_preference_eventId] PRIMARY KEY CLUSTERED ([member_remove_preference_eventId] ASC)
);
