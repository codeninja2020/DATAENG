CREATE TABLE [RedShift_coutts_production].[search_results_filters_updated] (
    ...
    CONSTRAINT [PK_RedShift_coutts_production_search_results_filters_updatedId] PRIMARY KEY CLUSTERED ([search_results_filters_updatedId] ASC)
);
