CREATE TABLE [RedShift_coutts_production].[submit_request_back] (
    ...
    [submit_request_backId]   BIGINT         IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_RedShift_coutts_production_submit_request_backId] PRIMARY KEY CLUSTERED ([submit_request_backId] ASC)
);
