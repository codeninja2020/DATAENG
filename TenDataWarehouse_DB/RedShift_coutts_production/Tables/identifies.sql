CREATE TABLE [RedShift_coutts_production].[identifies] (
    ...
    [identifiesId]            BIGINT         IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_RedShift_coutts_production_identifiesId] PRIMARY KEY CLUSTERED ([identifiesId] ASC)
);
