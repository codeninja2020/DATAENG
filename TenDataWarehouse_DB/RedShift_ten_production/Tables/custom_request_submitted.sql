CREATE TABLE [RedShift_ten_production].[custom_request_submitted] (
    ...
    CONSTRAINT [PK_RedShift_ten_production_custom_request_submittedId] PRIMARY KEY CLUSTERED ([custom_request_submittedId] ASC)
);
