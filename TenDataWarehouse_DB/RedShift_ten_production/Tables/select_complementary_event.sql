CREATE TABLE [RedShift_ten_production].[select_complementary_event] (
    ...
    [select_complementary_eventId] BIGINT         IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_RedShift_ten_production_select_complementary_eventId] PRIMARY KEY CLUSTERED ([select_complementary_eventId] ASC)
);
