CREATE TABLE [RedShift_ten_production].[close_complementary_ticket_selector] (
    ...
    [close_complementary_ticket_selectorId] BIGINT         IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_RedShift_ten_production_close_complementary_ticket_selectorId] PRIMARY KEY CLUSTERED ([close_complementary_ticket_selectorId] ASC)
);
