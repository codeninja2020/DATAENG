CREATE TABLE [RedShift_ten_production].[expedited_immigration_traveller_details_next] (
    ...
    CONSTRAINT [PK_RedShift_ten_production_expedited_immigration_traveller_details_nextId] PRIMARY KEY CLUSTERED ([expedited_immigration_traveller_details_nextId] ASC)
);
