CREATE TABLE [RedShift_ten_production].[submit_request_back] (
    ...
    CONSTRAINT [PK_RedShift_ten_production_submit_request_backId] PRIMARY KEY CLUSTERED ([submit_request_backId] ASC)
);
