CREATE TABLE [RedShift_ten_production].[custom_request_clicked] (
    ...
    CONSTRAINT [PK_RedShift_ten_production_custom_request_clickedId] PRIMARY KEY CLUSTERED ([custom_request_clickedId] ASC)
);
