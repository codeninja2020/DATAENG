CREATE TABLE [RedShift_ten_production].[expedited_immigration_flight_details_back] (
    ...
    [expedited_immigration_flight_details_backId] BIGINT         IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_RedShift_ten_production_expedited_immigration_flight_details_backId] PRIMARY KEY CLUSTERED ([expedited_immigration_flight_details_backId] ASC)
);
