CREATE TABLE [RedShift_ten_production].[member_add_preference_event] (
    ...
    CONSTRAINT [PK_RedShift_ten_production_member_add_preference_eventId] PRIMARY KEY CLUSTERED ([member_add_preference_eventId] ASC)
);
