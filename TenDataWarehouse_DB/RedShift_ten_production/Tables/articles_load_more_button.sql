CREATE TABLE [RedShift_ten_production].[articles_load_more_button] (
    ...
    CONSTRAINT [PK_RedShift_ten_production_articles_load_more_buttonId] PRIMARY KEY CLUSTERED ([articles_load_more_buttonId] ASC)
);
