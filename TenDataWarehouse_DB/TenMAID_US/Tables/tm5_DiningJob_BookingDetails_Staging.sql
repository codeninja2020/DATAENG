CREATE TABLE [TenMAID_US].[tm5_DiningJob_BookingDetails_Staging] (
    ...
    CONSTRAINT [PK_TenMAID_US_tm5_DiningJob_BookingDetails_Staging] PRIMARY KEY CLUSTERED ([RequestId] ASC)
);
