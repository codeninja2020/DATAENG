CREATE TABLE [TenMAID_US].[tm5_SchemeCategoryCustomization_Staging] (
    ...
    CONSTRAINT [PK_TenMAID_US_tm5_SchemeCategoryCustomization_Staging] PRIMARY KEY CLUSTERED ([SchemeCategoryCustID] ASC)
);
