CREATE TABLE [TenMAID_Global].[Country_Staging] (
    ...
    [ISO_CountryID]        NVARCHAR (255) NULL,
    ...
    CONSTRAINT [PK_TenMAID_Global_Country_Staging] PRIMARY KEY CLUSTERED ([CountryId] ASC)
);
