CREATE TABLE [TenMAID_Global].[MemberCommunication_Staging] (
    ...
    CONSTRAINT [PK_TenMAID_Global_MemberCommunication_Staging] PRIMARY KEY CLUSTERED ([CommunicationID] ASC)
);
