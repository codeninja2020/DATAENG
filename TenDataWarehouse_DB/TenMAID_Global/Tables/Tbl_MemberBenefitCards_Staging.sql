CREATE TABLE [TenMAID_Global].[Tbl_MemberBenefitCards_Staging] (
    ...
    CONSTRAINT [PK_TenMAID_Global_Tbl_MemberBenefitCards_Staging] PRIMARY KEY CLUSTERED ([MemberBenefitID] ASC)
);
