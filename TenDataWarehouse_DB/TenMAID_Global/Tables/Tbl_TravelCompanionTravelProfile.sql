CREATE TABLE [TenMAID_Global].[Tbl_TravelCompanionTravelProfile] (
    ...
    CONSTRAINT [PK_Tbl_TravelCompanionTravelProfile] PRIMARY KEY CLUSTERED ([TravelCompanionProfileID] ASC)
);
