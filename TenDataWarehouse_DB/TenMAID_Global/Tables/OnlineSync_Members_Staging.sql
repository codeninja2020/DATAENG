CREATE TABLE [TenMAID_Global].[OnlineSync_Members_Staging] (
    ...
    CONSTRAINT [PK_TenMAID_Global_OnlineSync_Members_Staging] PRIMARY KEY CLUSTERED ([Members_OnlineSync_ID] ASC)
);
