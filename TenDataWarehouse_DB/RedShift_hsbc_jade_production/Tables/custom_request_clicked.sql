CREATE TABLE [RedShift_hsbc_jade_production].[custom_request_clicked] (
    ...
    CONSTRAINT [PK_RedShift_hsbc_jade_production_custom_request_clickedId] PRIMARY KEY CLUSTERED ([custom_request_clickedId] ASC)
);
