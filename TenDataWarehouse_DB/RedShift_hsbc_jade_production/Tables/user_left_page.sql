CREATE TABLE [RedShift_hsbc_jade_production].[user_left_page] (
    ...
    CONSTRAINT [PK_RedShift_hsbc_jade_production_user_left_pageId] PRIMARY KEY CLUSTERED ([user_left_pageId] ASC)
);
