CREATE TABLE [RedShift_hsbc_jade_production].[submit_request_back] (
    ...
    CONSTRAINT [PK_RedShift_hsbc_jade_production_submit_request_backId] PRIMARY KEY CLUSTERED ([submit_request_backId] ASC)
);
