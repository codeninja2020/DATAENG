CREATE TABLE [RedShift_hsbc_jade_production].[submit_request] (
    ...
    CONSTRAINT [PK_RedShift_hsbc_jade_production_submit_requestId] PRIMARY KEY CLUSTERED ([submit_requestId] ASC)
);
