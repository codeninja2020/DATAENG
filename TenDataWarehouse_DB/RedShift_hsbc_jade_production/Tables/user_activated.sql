CREATE TABLE [RedShift_hsbc_jade_production].[user_activated] (
    ...
    CONSTRAINT [PK_RedShift_hsbc_jade_production_user_activatedId] PRIMARY KEY CLUSTERED ([user_activatedId] ASC)
);
