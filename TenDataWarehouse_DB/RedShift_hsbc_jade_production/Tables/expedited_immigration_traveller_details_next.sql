CREATE TABLE [RedShift_hsbc_jade_production].[expedited_immigration_traveller_details_next] (
    ...
    [expedited_immigration_traveller_details_nextId] BIGINT         IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_RedShift_hsbc_jade_production_expedited_immigration_traveller_details_nextId] PRIMARY KEY CLUSTERED ([expedited_immigration_traveller_details_nextId] ASC)
);
