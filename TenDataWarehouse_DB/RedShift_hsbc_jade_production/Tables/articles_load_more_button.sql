CREATE TABLE [RedShift_hsbc_jade_production].[articles_load_more_button] (
    ...
    [articles_load_more_buttonId] BIGINT         IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_RedShift_hsbc_jade_production_articles_load_more_buttonId] PRIMARY KEY CLUSTERED ([articles_load_more_buttonId] ASC)
);
