CREATE TABLE [RedShift_hsbc_jade_production].[partner_cta] (
    ...
    [partner_id]              NVARCHAR (512) NULL,
    [partner_link]            NVARCHAR (512) NULL,
    [partner_name]            NVARCHAR (512) NULL,
    ...
    [partner_ctaId]           BIGINT         IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_RedShift_hsbc_jade_production_partner_ctaId] PRIMARY KEY CLUSTERED ([partner_ctaId] ASC)
);
