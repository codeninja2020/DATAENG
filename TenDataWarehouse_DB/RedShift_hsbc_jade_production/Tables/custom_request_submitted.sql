CREATE TABLE [RedShift_hsbc_jade_production].[custom_request_submitted] (
    ...
    CONSTRAINT [PK_RedShift_hsbc_jade_production_custom_request_submittedId] PRIMARY KEY CLUSTERED ([custom_request_submittedId] ASC)
);
