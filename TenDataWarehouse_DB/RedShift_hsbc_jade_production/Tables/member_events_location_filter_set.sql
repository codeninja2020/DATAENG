CREATE TABLE [RedShift_hsbc_jade_production].[member_events_location_filter_set] (
    ...
    [value_name]              NVARCHAR (512) NULL,
    [value_tag_group]         NVARCHAR (512) NULL,
    [value_id]                BIGINT         NULL,
    [value_url]               NVARCHAR (512) NULL
);
