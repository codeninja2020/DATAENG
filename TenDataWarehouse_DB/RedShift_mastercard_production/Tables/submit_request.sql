CREATE TABLE [RedShift_mastercard_production].[submit_request] (
    ...
    CONSTRAINT [PK_RedShift_mastercard_production_submit_requestId] PRIMARY KEY CLUSTERED ([submit_requestId] ASC)
);
