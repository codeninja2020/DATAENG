CREATE TABLE [RedShift_mastercard_production].[member_add_preference_event] (
    ...
    CONSTRAINT [PK_RedShift_mastercard_production_member_add_preference_eventId] PRIMARY KEY CLUSTERED ([member_add_preference_eventId] ASC)
);
