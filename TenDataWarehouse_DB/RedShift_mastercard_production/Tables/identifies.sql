CREATE TABLE [RedShift_mastercard_production].[identifies] (
    ...
    CONSTRAINT [PK_RedShift_mastercard_production_identifiesId] PRIMARY KEY CLUSTERED ([identifiesId] ASC)
);
