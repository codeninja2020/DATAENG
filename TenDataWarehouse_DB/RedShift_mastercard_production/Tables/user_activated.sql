CREATE TABLE [RedShift_mastercard_production].[user_activated] (
    ...
    [opt_in_client_field_name] NVARCHAR (512) NULL,
    [opt_in_client_value]      VARCHAR (5)    NULL,
    ...
    CONSTRAINT [PK_RedShift_mastercard_production_user_activatedId] PRIMARY KEY CLUSTERED ([user_activatedId] ASC)
);
