CREATE TABLE [RedShift_mastercard_production].[user_left_page] (
    ...
    [user_left_pageId]        BIGINT         IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_RedShift_mastercard_production_user_left_pageId] PRIMARY KEY CLUSTERED ([user_left_pageId] ASC)
);
