CREATE TABLE [RedShift_mastercard_production].[custom_request_clicked] (
    ...
    CONSTRAINT [PK_RedShift_mastercard_production_custom_request_clickedId] PRIMARY KEY CLUSTERED ([custom_request_clickedId] ASC)
);
