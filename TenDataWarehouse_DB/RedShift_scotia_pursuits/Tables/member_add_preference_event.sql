CREATE TABLE [RedShift_scotia_pursuits].[member_add_preference_event] (
    ...
    CONSTRAINT [PK_RedShift_scotia_pursuits_member_add_preference_eventId] PRIMARY KEY CLUSTERED ([member_add_preference_eventId] ASC)
);
