CREATE TABLE [RedShift_scotia_pursuits].[search_results_filters_updated] (
    ...
    CONSTRAINT [PK_RedShift_scotia_pursuits_search_results_filters_updatedId] PRIMARY KEY CLUSTERED ([search_results_filters_updatedId] ASC)
);
