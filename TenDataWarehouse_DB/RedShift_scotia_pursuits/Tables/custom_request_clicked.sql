CREATE TABLE [RedShift_scotia_pursuits].[custom_request_clicked] (
    ...
    [custom_request_clickedId] BIGINT         IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_RedShift_scotia_pursuits_custom_request_clickedId] PRIMARY KEY CLUSTERED ([custom_request_clickedId] ASC)
);
