CREATE TABLE [RedShift_scotia_pursuits].[custom_request_submitted] (
    ...
    CONSTRAINT [PK_RedShift_scotia_pursuits_custom_request_submittedId] PRIMARY KEY CLUSTERED ([custom_request_submittedId] ASC)
);
