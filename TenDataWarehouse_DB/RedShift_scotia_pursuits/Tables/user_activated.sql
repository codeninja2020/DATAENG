CREATE TABLE [RedShift_scotia_pursuits].[user_activated] (
    ...
    CONSTRAINT [PK_RedShift_scotia_pursuits_user_activatedId] PRIMARY KEY CLUSTERED ([user_activatedId] ASC)
);
