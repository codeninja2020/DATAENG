CREATE TABLE [RedShift_scotia_pursuits].[user_left_page] (
    ...
    CONSTRAINT [PK_RedShift_scotia_pursuits_user_left_pageId] PRIMARY KEY CLUSTERED ([user_left_pageId] ASC)
);
