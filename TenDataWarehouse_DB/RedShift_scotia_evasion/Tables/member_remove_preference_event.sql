CREATE TABLE [RedShift_scotia_evasion].[member_remove_preference_event] (
    ...
    CONSTRAINT [PK_RedShift_scotia_evasion_member_remove_preference_eventId] PRIMARY KEY CLUSTERED ([member_remove_preference_eventId] ASC)
);
