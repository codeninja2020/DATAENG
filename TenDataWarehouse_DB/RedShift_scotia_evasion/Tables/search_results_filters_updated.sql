CREATE TABLE [RedShift_scotia_evasion].[search_results_filters_updated] (
    ...
    CONSTRAINT [PK_RedShift_scotia_evasion_search_results_filters_updatedId] PRIMARY KEY CLUSTERED ([search_results_filters_updatedId] ASC)
);
