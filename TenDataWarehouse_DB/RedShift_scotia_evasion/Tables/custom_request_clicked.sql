CREATE TABLE [RedShift_scotia_evasion].[custom_request_clicked] (
    ...
    CONSTRAINT [PK_RedShift_scotia_evasion_custom_request_clickedId] PRIMARY KEY CLUSTERED ([custom_request_clickedId] ASC)
);
