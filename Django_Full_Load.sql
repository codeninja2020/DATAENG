...
IF OBJECT_ID('cms.usp_Download_And_Load_S3_Files', 'P') IS NOT NULL
    DROP PROCEDURE cms.usp_Download_And_Load_S3_Files;
GO
...
SELECT COUNT(*) FROM django.articles

SELECT TOP 20 *
FROM OPENROWSET(
	BULK 'D:\S3\BE_DJANGO_POSTGRES_CSV\TP_20260209220038\articles.csv',
	SINGLE_CLOB
) AS FileContents;
